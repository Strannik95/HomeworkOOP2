...
public class Main {
    public static void main(String[] args) {
        ...
        GrassEater horse = new GrassEater("Лошадь", 3, 40);
        GrassEater gazelle = new GrassEater("Газель", 2, 45);
        GrassEater giraffe = new GrassEater("Жираф", 2, 4);
        Hunter hyena = new Hunter("Гиена", 5, 45);
        Hunter tiger = new Hunter("Тигр", 5, 79);
        Hunter bear = new Hunter("Медведь", 3, 60);
        EarthWater frog = new EarthWater("Лягушка", 1,"Болото");
        EarthWater snake = new EarthWater("Уж пресноводный", 1, "В разных местах");
        NotFlyBird peacock = new NotFlyBird("Павлин", 2);
        NotFlyBird penguin = new NotFlyBird("Пингвин", 4);
        NotFlyBird dodo = new NotFlyBird("Птица додо", 1);
        FlyBird gull = new FlyBird("Чайка", 5);
        FlyBird falcon = new FlyBird("Сокол", 3);
        FlyBird albatross = new FlyBird("Альбатрос", 5);
        ...
        horse.walk();
        horse.eat();
        GrassEater h = new GrassEater("Лошадь", 8, 40);
